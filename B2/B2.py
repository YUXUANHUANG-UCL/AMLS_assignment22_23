...
def get_B2_results():
    ...
    X_car, y_car_B2, X_car_fig = get_data_label_taskb(datasets[2], google_drive)#X_car, 
    X_car_test, y_car_test_B2, X_car_test_fig = get_data_label_taskb(datasets[3], google_drive)#X_car_test, 
    ...
    pred_car_B2 = img_SVM(X_car, y_car_B2, X_car_test, y_car_test_B2, titles, C=1)
    '''
