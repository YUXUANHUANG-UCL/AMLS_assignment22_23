...
def get_B1_results():
    # This function is the main function to solve Task B1
    ...
    # X_car is 1D image sequences, y_car_B1 is the labels of Task B1, X_car_fig is 3D color images
